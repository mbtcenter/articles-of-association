...
\begin{titlepage}
  ...
  \author{MELBOURNE BITCOIN TECHNOLOGY CENTER, INC.} 
  \title{Articles Of Association} 
  \shortdate
  \maketitle
  
  \section*{\centerline{Articles of Association of}}
  \section*{\centerline{MELBOURNE BITCOIN TECHNOLOGY CENTER, INC.}}
...
\section*{
    ...
    \textnormal{
    \begin{enumerate}
      \item An incorporated association has been established under the name ``Melbourne Bitcoin Technology Center, Inc." in all holdings.
    \end{enumerate}
    }
    \item Head Office
    \textnormal{
    \begin{enumerate}
      \item The Association is domiciled in Victoria.
    \end{enumerate}
    }
    \item Purpose
    \textnormal{
    \begin{enumerate}
      \item The purposes of the incorporated association is to promote and assist the adoption and growth of the Bitcoin trading economy and support businesses and consumers embrace digital currency and related technologies and assist our members work on building the future of money.
    \end{enumerate}
    } % end textnormal
    ...
    \textnormal{
    \begin{enumerate}
      \item ``Melbourne Bitcoin Technology Center, Inc." presently assists in the operation of the ``Melbourne Bitcoin Technology Center".
      \item ``Melbourne Bitcoin Technology Center" may be also be referred to as ``MBTC"  in publications, communication and common use.
      \item ``MBTC" does not, and shall not be deemed to refer to the association Melbourne Bitcoin Technology Center, Inc.
    \end{enumerate}
    }
    \item Membership
    \textnormal{
